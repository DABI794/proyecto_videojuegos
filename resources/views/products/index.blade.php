            ...
            <div class="bg-[#1e293b] border border-[#334155] rounded-2xl p-5 sticky top-20">
                ...
                <form action="{{ route('products.index') }}" method="GET" id="filter-form">
                    ...
                    <select
                        ...
                        class="w-full bg-[#0f172a] border border-[#334155] text-[#94a3b8] text-sm rounded-xl px-3 py-2 focus:outline-none focus:border-[#6366f1] transition-colors appearance-none"
                    >
